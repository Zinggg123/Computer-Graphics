...
namespace FluidSimulation
{
    ...
    namespace Lagrangian3d
    {
        ...
        public:
            ...
            float particlemass = Lagrangian3dPara::density * particleVolume;
            ...
            ////Poly6 Kernel
            //double m_kernelPoly6 = 315.0f / (64.0f * 3.141592f * pow(supportRadius, 9));
            ////Spiky Kernel
            //double m_kernelSpiky = -45.0f / (3.141592f * pow(supportRadius, 6));
            ////Viscosity Kernel
            //double m_kernelViscosity = 45.0f / (3.141592f * pow(supportRadius, 6));
        };
